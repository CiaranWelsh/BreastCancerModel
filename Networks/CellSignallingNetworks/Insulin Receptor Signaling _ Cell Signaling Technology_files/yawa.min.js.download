...
yawa_cmds.unshift(['YAWATracker.setCookieDomain', 'cellsignal.com']);
yawa_cmds.unshift(['YAWATracker.setSiteId', '4528891']);
    ...
    try{
var result = document.querySelector("input[name$='/SearchWithinFormHandler.searchTerm']").value; if(result && typeof yawa_cmds !== 'undefined'){ yawa_cmds.push(['YAWATracker.setGlobalEventProperty', 'internal_search_term', result]); }
}catch(yawa_custom_js_err){}
...
if(window.yawa_enable_evie_search_tracking){
var _201=new OWA.tracker();
_201.setSiteId(window.yawa_enable_evie_search_tracking);
document.addEventListener("yawa-evie-search-event",function(e){
try{
var _202=_201.makeEvent();
_202.setEventType("track.evie_search");
_202.set("search_event",btoa(JSON.stringify(e.detail)));
_201.trackEvent(_202);
}
catch(yawaERR){
}
});
