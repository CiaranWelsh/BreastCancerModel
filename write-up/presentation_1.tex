...
\subsection{Insulin and Amino Acids} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
\begin{frame}
...
%------------------------------------------------
\subsection{Amino acids plus insulin} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
\begin{frame}
...
\begin{figure}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../simulations/ExtendedPI3KModel/validations/AAWithEGFWithAZD/}
    \end{minipage}
    \rulesep
    \begin{minipage}{0.45\textwidth}
        \centering
